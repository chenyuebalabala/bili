            ...
            <el-table :data="rolelist" border stripe>
                ...
                <el-table-column type="expand">
                    <template slot-scope="scope">
                        <el-row :class="[i1 === 0?'bdtop' : '','venter']" v-for="(item1, i1) in scope.row.children" :key="item1.id">
                            <!-- 渲染一级权限 -->
                            <el-col :span="5">
                            ...
                            <el-col :span="19">
                                ...
                                <el-row :class="[i2 === 0?'' : 'bdtop','venter']" v-for="(item2, i2) in item1.children" :key="item2.id">
                                    ...
                                    <el-col :span="18">
                                        <el-tag :class="[i3 === 0?'' : '']" type="warning" v-for="(item3,i3) in item2.children" :key="item3.id" closable @close="removeRightById(scope.row,item3.id)">{{item3.authName}}</el-tag>
                                    </el-col>
                                </el-row>
                            </el-col>
                        </el-row>
...
export default {
  ...
  methods: {
    ...
    // 通过递归的形式，获取角色霞所有三级权限的Id,并保存到 defKeys 数组中
